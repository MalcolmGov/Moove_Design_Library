    ...
    >
      ...
      <div>
        <div className="p-5 flex items-center gap-3 border-b border-slate-100 dark:border-slate-800">
          ...
          <div>
            <h2 className="text-sm font-bold text-slate-900 dark:text-white tracking-tight leading-none">{brandName}</h2>
            <p className="text-[11px] text-slate-400 dark:text-slate-500 font-medium mt-1">{brandSubtitle}</p>
          </div>
        </div>
